...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                        ...
                        if (data.success) {
                            ...
                            /*
                                ...
                                注意：
                                    ...
                                    但是表单的jquery对象，没有为我们提供reset()方法让我们重置表单（坑：idea为我们提示了resert()方法）
            ...
            //因为我们动态生成的元素，是不能够以普通绑定事件的形式来进行操作的
            /*
            ...
            $("#deleteBtn").click(function () {
                ...
                if ($xz.length == 0) {
                    ...
                    if (confirm("确定删除所选中的记录码?")) {
                        ...
                        //将$xz中的每一个dom对象遍历出来，取其value值，求相当于取得了需要删除的记录的id
                ...
                if ($xz.length == 0) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            //处理单条activity
                            //首先以复选框的value值为id查询出对应的市场活动，然后在通查所有的User表，给修改模态窗口的所有者下拉框进行赋值，
                            //在把查询出来的市场活动表中的每项与模态窗口中的选项一一对应，但是在点击修改按钮时需要在重新发送一个ajax请求，这个
                            //ajax请求需要知道这个市场活动所对应的id，所以这里需要一个隐藏域将这张表所对应的id保存起来，方便以后给修改按钮使用。
        ...
        /*
            ...
            pageList方法：就是发送ajax请求到后台，从后台取得最新的市场活动信息列表数据，
                            ...
                            <%--
                                ...
                                关于文本域textarea：
                                    ...
                                    （2）textarea虽然是以标签对的形式来呈现的，但是它也是属于表单元素范畴
                                        我们对于所有的textarea的取值和赋值操作，应该统一使用val()方法(而不是html()方法）
