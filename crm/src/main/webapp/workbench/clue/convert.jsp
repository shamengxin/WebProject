...
<script type="text/javascript">
	$(function(){
		...
		$("#submitActivitBtn").click(function (){
		...
		$("#convertBtn").click(function (){
			...
			if($("#isCreateTransaction").prop("checked")){
				...
				//window.location.href="workbench/clue/convert.do?clueId=${param.id}&money=xxx,expectedDate=xxx&name=xxx&stage=xxx"
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="submitActivitBtn">提交</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<%--
			...
			提交表单行为结果：
				workbench/clue/convert.do？clueIc=xxx&money=xxx&name=xxx......
