...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //为关联市场活动模态窗口中的 搜索框 绑定事件，通过触发回车建，查询并展现所需市场活动列表
            ...
            $("#bundBtn").click(function () {
                ...
                if ($xz.length == 0) {
                    ...
                    //workbench/clue/bund.do?cid=xxx&aid=xxx&aid=xx&aid=xxx
                    ...
                    $.ajax({
                        ...
                        success:function (data){
                            ...
                            if(data.success){
                                ...
                                //清除搜索框中的信息 复选框中的√干掉 清空activitySerachBody中的内容
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<td>' + n.endDate + '</td>'
                        html += '<td>' + n.owner + '</td>'
                        html += '<td><a href="javascript:void(0);" onclick="unbund(\'' + n.id + '\')" tyle="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
                        html += '</tr>'
...
<div style="position: relative; top: 40px; left: 40px;">
    ...
    <div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;">
            <h5>哎呦！</h5>
            <font color="gray">线索</font> <font color="gray">-</font> <b>李四先生-傻萌新</b> <small
