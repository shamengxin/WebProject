	...
	<script>
		...
		/*
			...
			关于阶段和可能性：
				...
				如果遇到这种情况，我们需要properties属性文件来保存
				Stage2Possibility.properties
				01资质审查 = 10
				02需求分析 = 25
				.....

				Stage2Possibility.properties这个文件表示的是阶段和可能性之间的对应关系
		...
		$(function (){
			...
			$("#create-stage").change(function (){
				...
				/*
					...
					我们首先得将pMap转换为js中的js中的键值对关系json

					我们要做的是将pMap转换为json对象
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="11f233fd7a6e4da58c6df035c25c509b" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="a2e23d0ac3bf4ad18b03a64a099d3841" name="contactsId">
			</div>
		</div>
