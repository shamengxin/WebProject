<%@ page import="com.shamengxin.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.shamengxin.crm.workbench.domain.Tran" %>
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    -----------
    <span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" ata-content="价值建议" style="color: #90F790;"></span>
    -----------
...
<div style="position: relative; top: 100px; left: 40px;">
    ...
    <div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;">
            <h5>哎呦！</h5>
            <font color="gray">交易</font> <font color="gray">-</font> <b>傻萌新-交易01</b> <small style="color: gray;">
